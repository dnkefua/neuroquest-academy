...
const ARROWS = [
  { d: 'M 110,115 Q 160,20 210,45', color: '#F59E0B', stage: 'evaporation'   as WaterStage },
  { d: 'M 270,45 Q 340,30 370,115', color: '#93C5FD', stage: 'condensation'  as WaterStage },
  { d: 'M 390,160 Q 380,200 290,210',color: '#3B82F6', stage: 'precipitation' as WaterStage },
  { d: 'M 185,215 Q 120,230 90,160', color: '#14B8A6', stage: 'collection'   as WaterStage },
];

export default function WaterCycleDiagram({ activeStage }: { activeStage: WaterStage }) {
