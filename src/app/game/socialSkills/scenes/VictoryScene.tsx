...
export default function VictoryScene() {
  const { currentQuestId, score, questions, setScene } = useSocialSkillsStore();
  ...
  if (typeof window !== 'undefined') {
    ...
    confetti({
      ...
      spread: 70,
      origin: { y: 0.6 },
      colors: ['#EC4899', '#8B5CF6', '#14B8A6', '#F59E0B']
    });
  }
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4"
      ...
      <motion.div
        ...
        <motion.div
          ...
          <p className="text-pink-300 text-lg mt-2">
            You've completed this social skills adventure!
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          <div className="p-4 rounded-xl text-center">
            <div className="text-3xl mb-1">💰</div>
            <div className="text-2xl font-bold text-pink-400">{walletCoins}</div>
        ...
        {isPerfect && (
          <motion.div
            ...
            <p className="text-pink-300 font-bold">🎉 +100 Bonus Coins for Perfect Score!</p>
          </motion.div>
        )}
