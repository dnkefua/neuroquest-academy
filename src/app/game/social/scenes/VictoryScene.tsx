...
export default function VictoryScene() {
  const { currentQuestId, score, questions, setScene } = useSocialStore();
  ...
  if (typeof window !== 'undefined') {
    ...
    confetti({
      ...
      spread: 70,
      origin: { y: 0.6 },
      colors: ['#F59E0B', '#84CC16', '#F97316', '#22C55E']
    });
  }
      ...
      <motion.div
        ...
        <motion.div
          ...
          <p className="text-amber-300 text-lg mt-2">
            You've completed this social adventure!
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          <button
            ...
            style={{ background: 'linear-gradient(135deg, #F59E0B, #84CC16)' }}>
            Continue →
          </button>
