...
export default function QuizScene() {
  ...
  if (!question) return (
    <div className="h-dvh flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #0a1a0f, #0d2815)' }}>
  ...
  return (
    <div className="h-dvh overflow-hidden flex flex-col"
      style={{ background: 'linear-gradient(160deg, #0a1a0f 0%, #0d2815 60%, #071a0f 100%)' }}>
      ...
      <AnimatePresence mode="wait">
        <motion.div key={currentQuestion}
          ...
          <div className="flex-1 min-h-0 overflow-y-auto px-3 pt-2.5 pb-1">
            <ConceptAnimation subject="social" questTitle={quest?.title} color1={C1} color2={C2} />
